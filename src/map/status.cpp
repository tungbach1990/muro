...
int status_calc_mob_(struct mob_data* md, uint8 opt)
{
	...
	if (opt&SCO_FIRST) { // Set basic level on respawn.
		...
		md->bonus.max_damage = md->db->bonus.max_damage;
		md->bonus.max_rate = md->db->bonus.max_rate;
		md->bonus.max_eva = md->db->bonus.max_eva;
		md->bonus.max_block = md->db->bonus.max_block;
		md->bonus.max_pen_eva = md->db->bonus.max_pen_eva;
		md->bonus.max_pen_block = md->db->bonus.max_pen_block;
		md->bonus.max_pen_rate = md->db->bonus.max_pen_rate;
		md->bonus.max_damage_exceed = md->db->bonus.max_damage_exceed;
		md->bonus.max_damage_pen_exceed = md->db->bonus.max_damage_pen_exceed;
	}
