...
enum _sp {
	...
	SP_MAX_DAMAGE=2200,SP_MAX_RATE,SP_LIMIT_HP,SP_LIMIT_SP,SP_MAX_EVA,SP_MAX_BLOCK,SP_MAX_PEN_EVA,SP_MAX_PEN_BLOCK,SP_MAX_PEN_RATE,SP_MAX_DAMAGE_EXCEED,SP_MAX_DAMAGE_PEN_EXCEED,// 2200-2250
	SP_REBORN=2251,SP_ADD_REBORN, // 2251-2300
};
